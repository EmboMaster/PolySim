    ...
    def reset_all(self):
        ...
        if self.config.simulator.config.name == 'maniskill':
            try:
                ...
                self.simulator._env.scene.px.gpu_init()
        ...
        print(f"Device: {self.device}, Simulator: {self.simulator}, Dof_state: {self.simulator.dof_state.device}, Num_envs: {self.num_envs}")
